...
$string['config_blockTitleDefault'] = 'Resource List';
...
$string['config_buttonLabel'] = 'Check resource list';
$string['config_buttonTitle'] = 'Resource list';
$string['config_buttonDesc'] = 'The label of the button to display resource lists info in block';
